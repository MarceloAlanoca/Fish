...
@export var nombre_real := "Coral"
@export var calidad := "Celestial" #Boss cuando marcelo termine el minijuego
@export var vel_progresion := 1.0

var velocidad = Box_Vel.VelP["CoralVelocity"]
var direccion: Vector2 = Vector2(1, 0)
var distancia_maxima = Box_Vel.Dist["DistCoral"]
