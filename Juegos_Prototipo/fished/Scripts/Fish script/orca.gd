...
@export var nombre_real := "Orca"
@export var calidad := "Raro"
@export var vel_progresion := 1.0

var velocidad = Box_Vel.VelP["OrcaVelocity"]
var direccion: Vector2 = Vector2(1, 0)
var distancia_maxima = Box_Vel.Dist["DistOrca"]
...
func mirar_hacia_direccion():
	if has_node("OrcaSprite2D"):
		$OrcaSprite2D.flip_h = direccion.x > 0
